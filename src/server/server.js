...
//     const dbUser = 'adminuser';
//     const dbPassword = 'surkhi12345';
//     mongoUserCredentials = `${dbUser}:${dbPassword}`;
//     const MONGO_CONNECTION_STRING = `mongodb://${mongoUserCredentials}@ds251877.mlab.com:51877/${dbName}`;
...
//     var app = express();
//     app.use(cors())
//     server.applyMiddleware({ app: app }) //Graphiql Visualizer
